...
namespace SedgewickBookSolutions
{
    class Programs
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(a + " = " + quot + " * " + b + " + " + rem);  //Зачем столько раз писать +? в кавычках понятно, чтоб он отобразился, но зачем по обе стороны от кавычек писать +?
            ...
            double sqroot = Math.Sqrt(dis);            //Интересно, sqrt не существует а Sqrt работает. Значит заглавные буквы огромную роль играют в C#
